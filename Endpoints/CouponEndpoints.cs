    ...
    public static class CouponEndpoints
    {
        public static void ConfigureCouponEndpoints(this WebApplication app)
        {
            ...
            app.MapPost("/api/coupon", CreateCoupon)
                ...
                .Produces(400)
                .AddEndpointFilter<BasicValidator<CouponCreateDTO>>();
            ...
            app.MapDelete("/api/coupon/{id:int}", DeleteCoupon).AddEndpointFilter<ParameterIDValidator>();
        }
